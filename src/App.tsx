...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <div className={`fixed inset-0 ${isNightMode ? 'bg-gradient-to-b from-black/25 via-black/10 to-black/35' : 'bg-gradient-to-b from-slate-900/50 via-amber-950/20 to-slate-950/80'} pointer-events-none z-[1] transition-all duration-500`} />
      <div className={`fixed inset-0 ${isNightMode ? 'bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-black/10 to-black/30' : 'bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-black/20 to-black/70'} pointer-events-none z-[1] transition-all duration-500`} />
